...
class EstadisticaModel {
    ...
    private function calcularEstadisticasDashboard() {
        try {
            ...
            // Pedidos
            $stmt = $this->db->query("SELECT COUNT(*) as total FROM pedidos WHERE DATE(fecha_pedido) = CURDATE()");
 ...
 */
    public function obtenerProductosMasVendidos($limite = 5) {
        try {
            ...
            return [
                ['producto' => 'Comida Premium', 'total_vendido' => 45],
                ['producto' => 'Juguete Interactivo', 'total_vendido' => 32],
                ['producto' => 'Antipulgas', 'total_vendido' => 28],
                ['producto' => 'Shampoo', 'total_vendido' => 21],
                ['producto' => 'Snacks', 'total_vendido' => 18]
            ];
        }
    }
}
